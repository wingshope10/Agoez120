...
echo -e "$BIRed════════════════════════════════════${NC} "
echo -e "$BIRed  Wings Premium VPN Auto Script Service${NC}" 
echo ""  
...
clear
echo -e "$BIRed ┌─────────────────────────────────────────────────┐${NC}"
echo -e "$BIRed │                SSWS PANEL MENU                  │$NC"
echo -e "$BIRed └─────────────────────────────────────────────────┘${NC}"
echo -e " $BIRed ┌───────────────────────────────────────────────┐${NC}"
echo -e "   ${BIPurple}[${BIWhite}1${BICyan}] Create Shadowsock Account     "
echo -e "   ${BIPurple}[${BIWhite}2${BICyan}] Trial Shadowsock Account     "
echo -e "   ${BIPurple}[${BIWhite}3${BICyan}] Delete Shadowsock Account     "
echo -e "   ${BIPurple}[${BIWhite}4${BICyan}] Renew Shadowsock Account     "
echo -e "   ${BIPurple}[${BIWhite}5${BICyan}] Cek User Active XRAY     "
echo -e "   ${BIPurple}[${BIWhite}6${BICyan}] Detail Shadowsock Account     "
echo -e ""
echo -e "   ${BIPurple}[${BIWhite}0${BICyan}] Back To Menu     "
echo -e "${BIRed}└─────────────────────────────────────────────────────┘${NC}"
echo ""
