...
if [[ ! -z "${PID}" ]]; then
echo -e "${BIPurple}═════════════SSH ACCOUNTS═══════════${NC}"
echo -e "${BIPurple}════════════════════════════════════${NC}"
...
echo -e "${BIPurple}════════════════════════════════════${NC}"
echo -e "${BIPurple}Wings Premium VPN Auto Script Service${NC}" 
...
echo -e "GET / HTTP/1.1[crlf]Host: $domen[crlf]Connection: Keep-Alive[crlf]User-Agent: [ua][crlf]Upgrade: ws[crlf][crlf]"
echo -e "${BIPurple}════════════════════════════════════${NC}"
echo -e "${BIPurple} Wings Premium Auto Script Service${NC}"
fi
echo ""
...
clear
echo -e "${BIRed} ┌─────────────────────────────────────────────────┐${NC}"
echo -e "${BIRed} │                      SSH MENU                   │$NC"
echo -e "${BIRed} └─────────────────────────────────────────────────┘${NC}"
echo -e "${BIRed} ┌───────────────────────────────────────────────┐${NC}"
echo -e "   ${BIPurple}[1]${NC} Create SSH Account     "
echo -e "   ${BIPurple}[2]${NC} Trial SSH Acoount      "
echo -e "   ${BIPurple}[3]${NC} Delete SSH Acoount      "
echo -e "   ${BIPurple}[4]${NC} Renew SSH Account      "
echo -e "   ${BIPurple}[5]${NC} Cek User SSH     "
echo -e "   ${BIPurple}[6]${NC} Mullog SSH     "
echo -e "   ${BIPurple}[7]${NC} Auto Del user Exp     "
echo -e "   ${BIPurple}[8]${NC} Auto Kill user SSH    "
echo -e "   ${BIPurple}[9]${NC} Cek Member SSH"

echo -e "   ${BIPurple}[0]${NC} Back To Menu      "
echo -e "${BIRed} └───────────────────────────────────────────────┘${NC}"
echo ""
